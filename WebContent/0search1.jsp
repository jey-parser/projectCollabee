...
<head>
	...
	<link href="CollaStyle/0search1.css" rel="stylesheet" type="text/css">
            ...
            $.ajax({
            	...
            	success: function(d){
            		...
            		for(var i in d){
						...
						+ "<div class='second'>"
						+ "<a isprivate='0' class='wname' href='Controller?command=select_Workspace_Index&workspaceId="+workspace_id+"&workspaceName="+workspace_name+"&loginId=<%=loginId%>' workspaceId='"+ workspace_id +"'>" + workspace_name + " " + "</a>"
						+ "<div class='writer'>"
            ...
            $.ajax({
            	...
            	success: function(d){
            		...
            		for(var i in d){
						...
						+ "<button type='button' class='d_style'>"
						+ "<img src='https://down.collabee.co/postStatus/1603707' size='24' class='img1' data-project-no='126976' data-status-value='10'></button>"
						+ "<a target='_blank' class='d_title' href='Controller?command=showNewDocument&documentId=" + document_id +"&workspaceId=" + workspace_id + "&workspaceName=" + workspace_name + "&loginId=<%=loginId%>' documentId='"+ document_id +"'>"+ title +"</a></div>"
						+ "<div class='second'>"
						+ "<a isprivate='0' class='wname' href='Controller?command=select_Workspace_Index&workspaceId="+ workspace_id +"&workspaceName="+workspace_name+"' workspaceId='"+ workspace_id +"'>" + workspace_name + "</a>"
						+ "<div class='writer'>"
						+ "<span class='writer_name'>" + " " + name + " " + "</span></div>"
						+ "<span class='date'>" + edit_date + "</span></div></div>";
