...
<head>
    ...
    <link href="CollaStyle/web_admin.css" rel="stylesheet" type="text/css">
</head>
<body>
	<%@ include file="homepage_menu.jspf" %>

        <div class="collabee_backimg_web">
            <div class="collabee_title_web">관리자 기능</div>
            <div class="collabee_summary_web"><span>관리자 기능을 사용하여 동료와 협업공간을 관리할 수 있습니다.</span></div>
        </div>
