...
<!--
	1. 작성자 : 김유라, 강지현(다른 팀원 코드는 주석에 표기)
	2. 파일의 역할 : 오른쪽 일정, 할일, 의사결정 위젯
 -->
...
<head>
	...
	<link href="CollaStyle/Aside.css" rel="stylesheet" type="text/css">
