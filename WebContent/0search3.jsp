...
<head>
	...
	<link href="CollaStyle/0search3.css" rel="stylesheet" type="text/css">
            ...
            $.ajax({
            	...
            	success: function(d){
            		...
            		for(var i in d){
            			...
            			+ "</div>"
            			+ "<div class='cell2_line2'><a class='todo_workspace' href='Controller?command=select_Workspace_Index&workspaceId="+workspace_id+"&workspaceName="+workspace_name+"&loginId=<%=loginId%>' workspaceId='"+ workspace_id +"'>"+ workspace_name +"</a>"
            			+ "<a class='todo_document' href='Controller?command=showNewDocument&documentId=" + document_id +"&workspaceId=" + workspace_id + "&workspaceName=" + workspace_name + "&loginId=<%=loginId%>' documentId='"+ document_id +"'>"+ title +"</a>"
            			+ "</div>"
            			+ "</div>"
