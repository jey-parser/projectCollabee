...
public class ActionFactory {
	...
	Action getAction(String command) { 
		...
		case "WorkspaceOrder":
			...
			break;
		case "Option2Alarm":
			action = new Option2AlarmAction();
			break;
		case "IcandothisAllday":
			action = new IcandothisAlldayAction();
			break;
		case "StartAlarm":
			action = new StartAlarmAction();
			break;
		case "EndAlarm":
			action = new EndAlarmAction();
			break;
		case "SearchP1":
			action = new SearchP1Action();
			break;
		case "SearchP2":
			action = new SearchP2Action();
			break;
		case "SearchP3":
			action = new SearchP3Action();
			break;
		case "SearchP4":
			action = new SearchP4Action();
			break;
		case "SearchP1Nothing":
			action = new SearchP1NothingAction();
			break;
